...
frappe.ready(function() {
	...
	//// Neoffice — multi-warehouse: the live selector logic (source radios,
	//// preselection by quantity, per-source max) lives in the inline script of
	//// item_add_to_cart.html next to the real .btn-add-to-cart handler — the
	//// #item-add-to-cart / #item-spinner markup this file binds below no
	//// longer exists in our fork's template (vestigial upstream path, kept
